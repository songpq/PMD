...
public class FragmentBookingProceedPayment extends FragmentBase implements View.OnClickListener{

    private final static String TAG = FragmentBookingProceedPayment.class.getName();
