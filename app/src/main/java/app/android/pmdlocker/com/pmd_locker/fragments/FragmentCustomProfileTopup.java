...
public class FragmentCustomProfileTopup extends FragmentBase implements View.OnClickListener{

    private final static String TAG = FragmentCustomProfileTopup.class.getName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        try {
            ...
            View view = inflater.inflate(R.layout.fragment_custom_profile_topup, null);
            findId(view);
            initDefault();
            firstLoad();
    ...
    private void initDefault()
    {
        ...
        textVTitleTop.setText(Utility.getText(R.string.text_wallet_now,getActivity()).replace("{s}", String.valueOf(GlobalVariable.userLogin.getWalletAmount())));
        textVWalletAmount.setText(String.valueOf(GlobalVariable.userLogin.getWalletAmount()));
    ...
    public void onClick(View v)
    {
        ...
        switch (v.getId())
        {
            case R.id.textVTopupAction:
                Fragment fragment = ManagerChangeFragment.createFragment(fm, FragmentCustomProfileCreditVia.class.getName());
                ManagerChangeFragment.addFragment(fm, fragment, R.id.frameProfile, FragmentCustomProfileTopup.class.getName());
                break;
