...
public class FragmentBookingWhen extends FragmentBase implements View.OnClickListener{

    private final static String TAG = FragmentBookingWhen.class.getName();
