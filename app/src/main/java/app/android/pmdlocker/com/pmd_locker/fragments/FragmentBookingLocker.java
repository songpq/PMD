...
public class FragmentBookingLocker extends FragmentBase implements View.OnClickListener{

    private final static String TAG = FragmentBookingLocker.class.getName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        try {
            ...
            View view = inflater.inflate(R.layout.fragment_booking_need_locker, null);
            findId(view);
            initDefault();
            firstLoad();
    ...
    private void findId(View v)
    {
        ...
        textVTitleTop.setText(Utility.getTextHtml(R.string.text_why_need_locker,getActivity()));
    ...
    private void getListKioskSuccess(List<HLocker> lst)
    {
        ...
        LockerAdapterRecycleView lockerAdapterRecycleView = new LockerAdapterRecycleView(getActivity(),lst,GlobalVariable.WidthScreen,GlobalVariable.HeightScreen,null,null);
...
//                ManagerChangeFragment.addFragment(fm, fragment, R.id.frameProfile, FragmentBookingLocker.class.getName());
